...
**The pattern recognition problem is as follows:** Find a rule that discriminates \texttt{Oral} from \texttt{Fecal} samples based only on the bacterial composition. For this we need a supervised learning algorithm.
